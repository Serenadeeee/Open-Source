...
class ContactController extends Controller {
    ...
    public function contact(Request $request) {
        ...
        // SEO
        $meta_keywords = "DK Shop- Mua bán laptop chính hãng";
        $meta_title = "Liên hệ DK Shop- Mua bán laptop chính hãng";
        $meta_desc = "Đơn vị chuyên phân phối laptop với chất lượng và giá cả tốt nhất thị trường";
