            ...
            <form action="{{url('/luu-gio-hang')}}" method="post">
                ...
                <div class="wrap-product row">
                    ...
                    <ul class="col-sm-12 col-md-7 product-info">
                        ...
                        <li><b>Đơn vị tính:</b> <span>{{$value->product_quantity}} {{$value->product_unit}}</span></li>
                        <li><b>Số lượng sẵn có:</b> <span>{{$value->product_quantity}} </span></li>
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-6">
                                                    ...
                                                    @else
                                                    <button type="button" class="form-control btn btn-grape" onclick="add_to_cart()"><i class="fas fa-cart-plus"></i> Thêm vào giỏ hàng</button>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="product-contact">
                ...
                <div class="pro-contact-content">
                    ...
                    <form class="row col-md-6">
                        ...
                        <!-- <ul style="display: -webkit-inline-box;" class="rating">
                            @for($count = 1; $count <= 5; $count++)
                                ...
                                @endphp
                            <li id="{{$value->product_id}}-{{$count}}" data-index="{{$count}}" data-product_id="{{$value->product_id}}"
                            data-rating="{{$rating}}" class="list-inline rating" style="cursor: pointer; {{$color}} font-size: 30px;">&#9733;</li>
                            @endfor
                        </ul> -->
                        ...
                        @else
                        <a onclick="add_to_cart()"><input type="button" class="btn btn-grape" value="Bình luận"></a>
                        @endif
                    </form>
                </div>
            </div>
