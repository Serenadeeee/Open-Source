...
<head>
    ...
    <title>Đăng nhập - DK Shop</title>
    <link rel="shortcut icon" type="image/x-icon" href="{{('public/client/img/icoo-logo.png')}}">
            ...
            <div class="col-xl-10 col-lg-12 col-md-10">
                <div class="card o-hidden border-0 shadow-lg">
                    <div class="card-body p-0">
                        <div class="row">
                            <div style="background-color: #fcfcfc; position: relative;" class="col-lg-7 d-none d-lg-block">
                                <img style="width: 90%; position: absolute; bottom: 0;" src="{{url('/public/server/img/bg-login.png')}}">
                            </div>
                            <div class="col-lg-5">  
                                <div class="p-5">
