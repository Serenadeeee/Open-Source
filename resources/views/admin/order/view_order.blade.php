        ...
        <div class="row">
            ...
            <div class="col-md-6 table-responsive">
                <table class="table" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th colspan="2" class="text-center">Thông tin khách hàng đăng nhập</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <tbody>
                    ...
                    <tr class="color_qty_{{$details->product_id}}">
                        ...
                        <td style="display: flex; justify-content: center;">
                            <input style="width: 60px; margin-right: 4px;" {{$order_status != 1 ? 'disabled' : '' }} class="form-control tex-center order_qty_{{$details->product_id}}" type="number" min="1" name="product_sales_quantity" value="{{$details->product_sales_quantity}}">
