    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var chart = new Morris.Bar({
                element: 'chart-order',
                lineColors: ['#92278f', '#ccc', '#922', '#092'],
                hideHover: 'auto',
                parseTime: false,
                data: [
                    { period: '29/11/2021', order: 20, sales: 10, profit: 55, quantity: 20 },
                    { period: '30/11/2021', order: 10, sales: 23, profit: 54, quantity: 20 },
                    { period: '01/12/2021', order: 5, sales: 17, profit: 17, quantity: 20 },
                    { period: '02/12/2021', order: 7, sales: 30, profit: 35, quantity: 20 },
                    { period: '03/12/2021', order: 15, sales: 16, profit: 25, quantity: 20 },
                    { period: '04/12/2021', order: 17, sales: 28, profit: 15, quantity: 20 },
                    { period: '05/12/2021', order: 25, sales: 33, profit: 50, quantity: 20 }
                ],
                xkey: 'period',
